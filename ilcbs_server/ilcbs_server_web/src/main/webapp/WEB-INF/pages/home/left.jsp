...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-header">
            ...
            <div id="customerMenu">
                <div class="FastMenu"><img src="${ctx}/skin/default/images/notice.gif" style="margin-right:5px;" border="0"/><font color="gray"><a href="main.jsp" target="main">您还没定义您的菜单</a></font>
                </div>
            </div>
        </div>
    </div>
